...
import { addDoc, onSnapshot, query, orderBy, getDocs, getDoc, updateDoc } from 'firebase/firestore'
...
export default function CreatePrescription() {
  ...
  const fetchPrescriptionData = useCallback(async () => {
    ...
    try {
      ...
      const prescriptionRef = getBusinessDoc(businessId, 'prescriptions', id)
      ...
      if (prescriptionSnap.exists()) {
        ...
        const appointmentRef = getBusinessDoc(businessId, 'appointments', id)
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        // Fetch patients from appointments (multi-tenant)
        ...
        // Fetch medicines (multi-tenant)
        const medicinesRef = getBusinessCollection(businessId, 'medicines')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        await addDoc(getBusinessCollection(businessId, 'prescriptions'), prescriptionData)
